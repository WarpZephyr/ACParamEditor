...
{
    public class CsvParser : ISpreadSheetParser
    {
        ...
        public CsvParser(Stream stream, Encoding encoding, string name = "", bool leaveOpen = false)
        {
        ...
        public static CsvParser OpenFile(string path, Encoding encoding)
            => new CsvParser(File.OpenRead(path), encoding, Path.GetFileNameWithoutExtension(path), false);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CsvParser OpenFile(string path, Encoding encoding, string name)
            => new CsvParser(File.OpenRead(path), encoding, name, false);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CsvParser OpenBytes(byte[] bytes, Encoding encoding, string name = "")
            => new CsvParser(new MemoryStream(bytes), encoding, name, false);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CsvParser OpenStream(Stream stream, Encoding encoding, string name = "", bool leaveOpen = false)
            => new CsvParser(stream, encoding, name, leaveOpen);
